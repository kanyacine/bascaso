...
This document defines the backend architecture, security model, and data strategy for Bascaso. All server-side code must follow these conventions.
...
└── /data/bascaso.db → SQLite database
```
